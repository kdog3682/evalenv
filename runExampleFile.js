...
import {
    LineEditor,
    getDashedText
} from "/home/kdog3682/2024-javascript/js-toolkit/LineEditor.js"
...
function main(options) {
    const [vim] = sysArgs()
    if (vim == null) {
        return console.log("no args -> early return")
    }

    assert(isVimState(vim))
...
async function dashed(text, options = {}) {
    ...
    const get = async (config) => {
        if (config.exit) {
            ...
            const modules = await loadModules(config.code, options)
...
const dynamicImports = [
    { name: 'vim', file: '/home/kdog3682/2024-javascript/stdlib/vim/index.js', regex: /\bvim\./ },
    { name: 'foobar', file: '/home/kdog3682/2024-javascript/stdlib/foobar/index.js', regex: /\bfoobar\./ },
    { name: 'lezer', file: '/home/kdog3682/2024-javascript/stdlib/lezer/index.js', regex: /main\(state\)/ },
];
...
async function loadModules(code, options) {
    ...
    for (const c of options.dynamicImports || []) {

...
/* deno-fmt-ignore */ import {getAppFunction, append, requestAppend, requestWrite, denoImports, notify, read, denoFileRunner, cwd, readdir, rpw, bash, sysArgs, write, npath} from "/home/kdog3682/2024-javascript/nodekit/deno.js"
...
function createVimCommand(desc, result, config) {
    const name = camelCase(desc)
    const denoFunctionWrapper = config.inpath ? "rpw" : "default"
    ...
    const ext = ".js"
    const dir = "/home/kdog3682/2024-javascript/generated/apps/"
...
export default createVimCommand 
